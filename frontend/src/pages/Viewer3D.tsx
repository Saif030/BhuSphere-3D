...
export default function Viewer3D() {
  ...
  useEffect(() => {
    ...
    setFloorId(null); setUnitId(null); needFloor.current = true; needUnit.current = true;
  }, [bkey]);
  ...
  return (
    <div className="p-4 space-y-3">
      ...
      <div className="space-y-3">
        ...
        {b && <Building3D key={viewKey} building={b} selectedFloor={floorId} onFloor={(f) => { setFloorId(f); setUnitId(null); }}
          selectedUnit={unitId} onUnit={(u) => setUnitId(u)} exploded={exploded} underground={underground} utilities={utils || []} />}
